...
const Wallpaper = () => {
  ...
  return (
    ...
    <div className="flex w-[100%] h-[40px] items-center text-center justify-center mb-[20px]">
      ...
      <button className='text-blue-500 absolute left-1 flex' onClick={handleBack}><svg width="24px" height="24px" viewBox="0 0 1024.00 1024.00" fill="#3b82f6" class="icon" version="1.1"  transform="rotate(270)" stroke="#3b82f6" stroke-width="35.839999999999996"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M509.928 387.16c7.24-7.991 17.58-7.898 24.782 0.333l270.568 309.222c7.759 8.867 21.237 9.765 30.103 2.007 8.867-7.759 9.766-21.237 2.007-30.103L566.82 359.397c-24-27.429-64.127-27.792-88.507-0.89L197.526 668.342c-7.912 8.73-7.249 22.221 1.482 30.133 8.73 7.912 22.221 7.249 30.133-1.482L509.928 387.16z" fill=""></path></g></svg>
        Back</button>
     <h3 className='text-white text-center text-[18px] font-sans font-medium'>Chat Wallpaper</h3>

     </div>
      <div className='mr-[10px] ml-[10px]'>

      <div className='bg-zinc-900 mb-[3px] rounded-[10px] py-[5px] text-blue-600'>
     <p className=' absolute ml-2 bg-transparent items-center text-start  text-blue-600 text-[18px]'>Choose From Photos</p>
